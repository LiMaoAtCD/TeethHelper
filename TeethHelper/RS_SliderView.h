...
#define handleWidth 60.0 // handle width
#define borderWidth 1.0 // size of border under the slider
#define viewCornerRadius 10.0 // view corners radius
#define animationSpeed 0.01 // speed when slider change position on tap
...
@property (nonatomic, strong) UIImageView *handleUpImageView;
